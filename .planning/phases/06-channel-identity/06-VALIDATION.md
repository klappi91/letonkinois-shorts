...
| 06-01-03 | 01 | 1 | IDENT-02 | build | `npm run build` | ❌ W0: SAFE_ZONES in brand.ts | ⬜ pending |
| 06-01-04 | 01 | 1 | IDENT-03 | build + visual | `npm run build` + manual Remotion Studio | ❌ W0: create ColorGrade.tsx | ⬜ pending |
| 06-02-01 | 02 | 2 | IDENT-04 | build | `npm run build` | ❌ W0: create moodboard/page.tsx | ⬜ pending |
| 06-02-02 | 02 | 2 | IDENT-04 | file check | `ls public/assets/moodboard/ | wc -l` | ❌ Manual: collect screenshots | ⬜ pending |
...
- [ ] `public/assets/moodboard/` directory + 5 screenshots — manual collection
...
| Moodboard screenshots represent target style | IDENT-04 | Subjective content selection | Review 5+ screenshots in /moodboard route, verify they show premium wood-finishing aesthetic per competitor research |
| 5 Gemini test images match Style Guide | IDENT-01 | Visual style compliance | Generate 5 test images using brand.ts Gemini prompt fragments, verify no forbidden aesthetics present |
