...
const SEQ = "sequences/gartenmoebel-renovation";

// --- HOOK: Ergebnis zuerst, kurzer starker Text ---
...
const OelenScene: React.FC = () => {
  return (
    <ImageScene src={`${SEQ}/04-oelen.png`}>
...
export const GARTENMOEBEL_RENOVATION_DURATION = 736;

export const GartenmobelRenovation: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: colors.white }}>
      <TransitionSeries>
        {/* Hook: Ergebnis + "Ein Samstag." */}
